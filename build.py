...
Una sola página (index.html) con selector Costa Rica / Nicaragua: todo el
contenido que difiere por sede vive en el componente React del propio
.dc.html (ver COPY en el bloque data-dc-script) y se resuelve en el
navegador según la pestaña activa — no hay una segunda página ni una
segunda URL."""
...
<meta name="description" content="Certifícate como Business &amp; Team Coach con la Metodología LEGO® Serious Play®. Certificaciones en Costa Rica (octubre) y Nicaragua (diciembre) 2026, máximo 12 cupos por sede. Elegí tu sede en la página.">
<meta property="og:title" content="Certificación Business &amp; Team Coaching con LEGO® Serious Play® | Costa Rica · Octubre 2026">
<meta property="og:description" content="Certificaciones en Costa Rica (octubre) y Nicaragua (diciembre) 2026, máximo 12 cupos por sede. Elegí tu sede en la página.">
